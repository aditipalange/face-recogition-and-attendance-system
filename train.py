...
class Train:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\Admin\Desktop\project2\Images_GUI\t_bg1.jpg")
        bg1=bg1.resize((1400,768),Image.LANCZOS)
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"C:\Users\Admin\Desktop\project2\Images_GUI\t_btn1.png")
