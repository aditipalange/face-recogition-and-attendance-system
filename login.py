...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Admin\Desktop\project2\Images_GUI\loginBg1.jpg")
        ...
        img1=Image.open(r"C:\Users\Admin\Desktop\project2\Images_GUI\log1.png")
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            if row==None:
                messagebox.showerror("Error","Invalid Username or Password please enter again !!")
            else:
                open_min=messagebox.askyesno("YesCancel","Click on yes to login")
                if open_min>0:
                    self.new_window=Toplevel(self.root)
...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\Admin\Desktop\project2\Images_GUI\bg3.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\Admin\Desktop\project2\Images_GUI\std1.jpg")
        ...
        det_img_btn=Image.open(r"C:\Users\Admin\Desktop\project2\Images_GUI\det1.jpg")
        ...
        att_img_btn=Image.open(r"C:\Users\Admin\Desktop\project2\Images_GUI\att.jpg")
        ...
        att_b1_1.place(x=710,y=280,width=180,height=45)
                ...
                # Train   button 5
        tra_img_btn=Image.open(r"C:\Users\Admin\Desktop\project2\Images_GUI\tra1.jpg")
